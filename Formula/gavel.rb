class Gavel < Formula
  ...
  url "https://github.com/JaysonRawlins/claude-gavel/releases/download/v1.24.1/gavel-v1.24.1-macos-arm64.tar.gz"
  sha256 "20c58003550eebd14dfb7512f8e9f6a298c9db7fe3d1ec22b936d16e1e592e9a"
  license "MIT"
  version "1.24.1"
